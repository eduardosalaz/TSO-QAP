...
function tabuSearch(costM::Matrix{Int64}, Σ₀::Int64, locations₀::Vector{Int64}, verbose::Bool, number::Int64, full::Bool, iters::Int64)
...
function parseFileTS(path::String, verbose::Bool, numero::Int64, full::Bool, iters::Int64)
    ...
    start = time_ns()
    Σ₁, locations₁, X₁ = tabuSearch(costM, Σ₀, locations₀, verbose, numero, full, iters)
    finish = time_ns()

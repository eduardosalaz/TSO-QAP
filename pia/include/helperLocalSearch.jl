...
function decisionMatrix(locations::Vector{Int64})::Matrix{Int64} # funcion para generar la matriz de decisión en base a la lista de localizaciones
...
function parseFile(path::String, verbose::Bool)
    ...
    improvement = Σ₀ - Σ₁  
    println("Improvement of: $improvement")
